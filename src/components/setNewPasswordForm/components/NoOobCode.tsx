...
export const NoOobCode: FC = () => {
    return <Card>
        <CardHeader className="text-center">
            ...
            <CardDescription>
                {setNewPasswordFormTexts.noOobCode.description}
            </CardDescription>
        </CardHeader>
        <CardFooter className="justify-center">
            <Link className={cn([buttonVariants({variant: "secondary"}), 'grow'])}
                  href={appPaths.auth.login}>{setNewPasswordFormTexts.buttons.backToLogin}</Link>
        </CardFooter>
    </Card>
};