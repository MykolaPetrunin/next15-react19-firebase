...
export const SetNewPasswordForm: FC<{
    ...
    return <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6"><Card>
            <CardHeader className="text-center">
                <CardTitle className="text-xl">{setNewPasswordFormTexts.title}</CardTitle>
                <CardDescription>
                    {setNewPasswordFormTexts.description}
                </CardDescription>
            </CardHeader>
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="password"
                                       placeholder={setNewPasswordFormTexts.inputs.password.placeholder} {...field} />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="password"
                                       placeholder={setNewPasswordFormTexts.inputs.repeatPassword.placeholder} {...field} />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}
