                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9">
                    <Card>
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>
                                {resetPasswordFormTexts.subTitle}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                placeholder={resetPasswordFormTexts.input.placeholder} {...field} />
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
                                )}
