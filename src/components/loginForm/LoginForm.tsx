...
export const LoginForm: FC<{
    ...
    ({signUp, resetPassword, signIn, signInWithGoogle}) => {
        ...
        const onSubmit = useCallback(async (values: z.infer<typeof loginFormSchema>) => {
            await signIn(values);
        }, [signIn]);
                                            ...
                                            render={({field}) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input
                                                            disabled={form.formState.isSubmitting || isGoogleSignInLoading}
                                                            placeholder={loginFormTexts.inputs.email.placeholder} {...field} />
                                                    </FormControl>
                                                    <FormMessage/>
                                                </FormItem>
                                            )}
                                            ...
                                            render={({field}) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input type="password"
                                                               disabled={form.formState.isSubmitting || isGoogleSignInLoading}
                                                               placeholder={loginFormTexts.inputs.password.placeholder} {...field} />
                                                    </FormControl>
                                                    <FormMessage/>
                                                </FormItem>
                                            )}
